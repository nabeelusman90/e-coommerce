...
///   error  - This api IS wonr 
    ...
    return (
        ...
        <div  style={{display:"flex"}}><h6>via Call:</h6> <p className='abut'>0307-5620090 <br/>03266046251</p></div>
        <div  style={{display:"flex"}}><h6>via e-mail:</h6> <p className='abut'>itsihtsham667@gmail.com  <br/>nabeelusman786edf@gmail.com</p></div>
